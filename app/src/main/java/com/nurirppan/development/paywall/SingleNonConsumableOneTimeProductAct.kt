...
import com.nurirppan.development.databinding.ActivitySingleNonConsumableOneTimeProductBinding
import java.io.IOException
import java.util.*

class SingleNonConsumableOneTimeProductAct : AppCompatActivity(), PurchasesUpdatedListener {

    private lateinit var binding: ActivitySingleNonConsumableOneTimeProductBinding

    private var billingClient: BillingClient? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySingleNonConsumableOneTimeProductBinding.inflate(layoutInflater)
        ...
        if (purchaseValueFromPref) {
            ...
            binding.purchaseStatus!!.text = "Purchase Status : Purchased"
        }
        //item not Purchased
        else {
            binding.purchaseButton!!.visibility = View.VISIBLE
            binding.purchaseStatus!!.text = "Purchase Status : Not Purchased"
        }
    }
    ...
    private fun verifyValidSignature(signedData: String, signature: String): Boolean {
        return try {
            ...
            SingleNonConsumableOneTimeProductSecurity.verifyPurchase(
                base64Key,
                signedData,
                signature
            )
    ...
    companion object {
        ...
        const val PURCHASE_KEY = "SingleNonConsumableOneTimeProduct"
        const val PRODUCT_ID = "purchase_id"
    }
}
